...
int insListeVide (Liste * liste, tActor *donnee){
...
int insDebutListe (Liste * liste, tActor *donnee){
    Element *nouveau_element;
...
int insFinListe (Liste * liste, Element * courant, tActor *donnee){
    Element *nouveau_element;
...
int insListe (Liste * liste, tActor *donnee, int pos){
    if (liste->taille < 2){
        return -1;
    }
